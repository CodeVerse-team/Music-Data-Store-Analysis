...
-- Write a query to return customer name, artist name and total spentQ1: 
...
-- highest amount of purchases. write a query that returns each 
-- country along with the top genre. for countries where the maximum
...
-- music for each country. Write a query that returns the country 
