...
-- and Genre of all the Rock mussic listerners. Reutrrn your list
-- ordered alphabetically by email starting wiht A
...
-- Write a query that returns the Artist name and total track count of the top 10rock bands
